...
rf800
rf900
# When ntree = 800, the OOB error rate stabilizes and reach minimum.

```

#### Step 4: Find the optimal number of variables selected at each split and apply to the training data
```{r}
